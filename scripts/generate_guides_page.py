...
<section class="wrap cta"><div><h2>先审计，再装一个当前真需要的。</h2><p>第三方 Skill 先检查脚本、联网和文件操作；从小任务开始，保留客户端版本、原始任务和实际输出。</p></div><a href="../audit-skill/">先做安装前审计 →</a></section></main>
