...
def render_card(item):
    ...
    if item["kind"] == "historical":
        ...
        evidence = f'''<strong>成功门槛（尚未执行）</strong><ul>{checks}</ul><a href="{ISSUE}">提交成功、失败或未触发结果 →</a>'''
        badge = "前瞻任务"
