...
def validate_records(records):
    ...
    if len(verbatim) != 6 or len(summary) != 7:
        raise ValueError(f"expected 6 verbatim and 7 summary-only records, got {len(verbatim)} and {len(summary)}")
...
<title>6 个可逐字复现的中文 Agent Skill 测试任务</title>
<meta name="description" content="复制安装命令和逐字任务原文，复现 6 个中文 Agent Skills 的 Codex 自动触发与边界测试；另外 7 项仅保留摘要，不反向编造提示词。">
<link rel="canonical" href="{BASE}reproduce/"><meta property="og:type" content="article"><meta property="og:locale" content="zh_CN"><meta property="og:title" content="6 个可逐字复现的中文 Agent Skill 测试任务"><meta property="og:description" content="安装、复制任务、对照原始案例；逐字原文与任务摘要严格分开。"><meta property="og:url" content="{BASE}reproduce/"><meta property="og:image" content="{BASE}og.png"><meta property="og:image:width" content="1200"><meta property="og:image:height" content="630"><meta property="og:image:alt" content="6 个可逐字复现的中文 Agent Skill 测试任务"><meta name="twitter:card" content="summary_large_image"><meta name="twitter:title" content="6 个可逐字复现的中文 Agent Skill 测试任务"><meta name="twitter:description" content="安装、复制任务、对照原始案例；逐字原文与任务摘要严格分开。"><meta name="twitter:image" content="{BASE}og.png"><meta name="twitter:image:alt" content="6 个可逐字复现的中文 Agent Skill 测试任务">
<script type="application/ld+json">{{"@context":"https://schema.org","@type":"TechArticle","headline":"6 个可逐字复现的中文 Agent Skill 测试任务","description":"从仓库案例中提取的逐字任务原文与复现入口。","inLanguage":"zh-CN","dateModified":"2026-08-12","mainEntityOfPage":"{BASE}reproduce/","image":"{BASE}og.png","author":{{"@type":"Organization","name":"中文 AI Skills 库"}}}}</script>
