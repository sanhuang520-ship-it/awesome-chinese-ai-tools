...
**[🌐 在线浏览（可搜索筛选）](https://sanhuang520-ship-it.github.io/awesome-chinese-ai-tools/)**　·　[🧪 实测案例](cases/)　·　[📊 兼容性](COMPATIBILITY.md)　·　[🛡️ 质量标签](QUALITY.md)　·　[🧰 中文开箱组合](https://sanhuang520-ship-it.github.io/awesome-chinese-ai-tools/bundles/)　·　[📋 完整清单](SKILLS.md)　·
...
安装与自动触发不是一回事。本站 13 个原创 Skill 已完成 CLI 发现与当前 Codex 安装内容核验，已有 **9 个 Skill** 发生不点名名称的 Codex 自动触发，其中 1 项触发后任务未完成；失败也公开保留。详见 **[兼容性实测表](COMPATIBILITY.md)**。
