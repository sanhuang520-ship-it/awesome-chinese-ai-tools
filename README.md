...
> ③ 212 个 Skill 条目来自 164 个仓库，来源仓库**定期复检**一次还在不在（最近 2026-09-15），不转述无法复核的 AI 新闻
...
另有 **47 个 AI 工具导航的归档快照**（2026-09-14 起不再复检，链接与额度信息停留在当时，使用前请到官网核对）。
...
| 2 | **164 个来源仓库复检**（覆盖 212 个 Skill 条目）：还在不在、星数、最后更新时间 |
| 3 | 从数据重建 SKILLS.md，并同步公开统计 |
...
<div align="center">
<sub>MIT License · 数据最后复检 2026-09-15 · 公开统计由脚本同步于 2026-09-15</sub>
</div>
