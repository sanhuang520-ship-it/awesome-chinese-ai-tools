...
**[→ 不知道先试哪个？查看 13 个单项安装命令与可复制首次任务](https://sanhuang520-ship-it.github.io/awesome-chinese-ai-tools/try-agent-skills/)**：7 条来自历史逐字原文；6 条是运行前公开的前瞻任务，其中 4 条已执行、2 条仍待测，两类证据不会混写。
...
**[→ 参与前瞻兼容性复测](https://sanhuang520-ship-it.github.io/awesome-chinese-ai-tools/retest/)**（6 条任务和门槛先公开；3 条通过 4/4、1 条为 3/4 失败，2 条仍为 `planned`）
