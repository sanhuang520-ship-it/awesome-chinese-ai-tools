...
An evidence-first directory of **212 Agent Skill entries from 164 source repositories**, focused on Chinese-language workflows. This repository also maintains 13 first-party Skills and an archived snapshot of 47 AI tool links.
...
- **Periodic source checks:** GitHub Actions rechecks the 164 source repositories every Monday (manual runs are also possible), and every run is publicly logged. The AI tool links are an archived snapshot as of 2026-09-14 and are no longer rechecked. A live link does not prove current pricing, safety, or client compatibility.
