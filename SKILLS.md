...
> **116 个 Skill｜116 个中文说明｜✍️ 11 个本站原创**  
...
| [shuorenhua](https://github.com/MrGeDiao/shuorenhua) | ⭐962 | 「说人话」去 AI 味改写：保事实、分场景、改完可直接发 |
| [Awesome-Journal-Skills](https://github.com/brycewang-stanford/Awesome-Journal-Skills) | ⭐922 | 主流期刊投稿技能包（AER、QJE 等经济学顶刊） |
| [speak-human-tw](https://github.com/Raymondhou0917/speak-human-tw) | ⭐752 | 繁体中文去 AI 味：抓 38 种 AI 写作痕迹，校正用语与标点 |
...
| [xiaohongshu-skills](https://github.com/vivy-yi/xiaohongshu-skills) | ⭐353 | 139 个小红书运营技能：内容创作、账号运营、电商转化等 9 大类 🕰<sub>2026-01-23 后未更新</sub> |
| [docx-skill-4-cn-paper](https://github.com/Gostyan/docx-skill-4-cn-paper) | ⭐352 | 中文论文排版规范：课程论文、数模竞赛、毕业论文 |
| [humanities-writing-companion](https://github.com/tizzy916/humanities-writing-companion) | ⭐350 | 人文学科写作助手：11 种模式覆盖构思到成稿 |
...
| [humanizer-zh-academic](https://github.com/redbaronyyyyy-eng/humanizer-zh-academic) | ⭐237 | 降低中文学术写作 AIGC 检测率 |
| [awesome-skills-cn](https://github.com/lingxling/awesome-skills-cn) | ⭐229 | 热门 Skills 中文学习版 + 教程，7000+ 收录 |
...
| [technical-writing](https://github.com/luoling8192/technical-writing) | ⭐206 | 中文技术写作：设计文档、评审稿、复盘、分享稿 |
| [SecSkills](https://github.com/Arenbai/SecSkills) | ⭐202 | 渗透测试技能模块，遵循 PTES 标准全阶段覆盖 |
...
| [JobOK](https://github.com/GresonKwan/JobOK) | ⭐116 | 中文求职：优势挖掘、岗位匹配、简历优化、面试训练 |
| [hermes-arxiv-agent](https://github.com/genggng/hermes-arxiv-agent) | ⭐110 | 每天自动抓 arXiv 论文，生成中文摘要推送到飞书 |
| [kc_ai_skills](https://github.com/KerberosClaw/kc_ai_skills) | ⭐77 | 中文优先的 Claude Code / Codex skills 合集 |
| [wechat-writing-style](https://github.com/yaoleifly/wechat-writing-style) | ⭐75 | 微信公众号中文写作风格 |
...
| [NotebookLM Integration](https://github.com/PleasePrompto/notebooklm-skill) | ⭐7,581 | 让 Claude Code 直接对话 NotebookLM，做有出处的问答 🕰<sub>2025-11-21 后未更新</sub> |
| [article-extractor](https://github.com/michalparkola/tapestry-skills-for-claude-code/tree/main/article-extractor) | ⭐513 | 从网页提取完整文章正文与元数据 |
...
| [test-driven-development](https://github.com/obra/superpowers/tree/main/skills/test-driven-development) | ⭐268,114 | 测试驱动开发全流程指导，写代码前先写测试 |
| [using-git-worktrees](https://github.com/obra/superpowers/blob/main/skills/using-git-worktrees/) | ⭐268,114 | 自动创建隔离的 git worktree，多分支并行开发不打架 |
...
| [software-architecture](https://github.com/NeoLabHQ/context-engineering-kit/tree/master/plugins/ddd/skills/software-architecture) | ⭐1,305 | 实现整洁架构、SOLID 等设计模式 |
| [prompt-engineering](https://github.com/NeoLabHQ/context-engineering-kit/tree/master/plugins/customaize-agent/skills/prompt-engineering) | ⭐1,305 | 系统讲解提示词工程的技巧与模式 |
| [iOS Simulator](https://github.com/conorluddy/ios-simulator-skill) | ⭐1,206 | 操作 iOS 模拟器做 App 测试 |
| [AppGenesisForge](https://github.com/pcliangx/AppGenesisForge) | ⭐413 | 19 个角色协作的 AI Agent 团队脚手架，按阶段门禁推进 |
| [aws-skills](https://github.com/zxkane/aws-skills) | ⭐344 | AWS 开发：CDK 最佳实践、成本优化、Serverless 架构 |
...
| [youtube-transcript](https://github.com/michalparkola/tapestry-skills-for-claude-code/tree/main/youtube-transcript) | ⭐513 | 抓取 YouTube 视频字幕并整理成摘要 |
| [imagen](https://github.com/sanjay3290/ai-skills/tree/main/skills/imagen) | ⭐366 | 调用 Google Gemini 图像生成 API 出图 |
...
| [pakco-html](https://github.com/pakco77/pakco-html) | ⭐69 | HTML 审美库（中文）：60+ 视觉风格、演示页/长页模板，一键复制 Prompt |
...
| [brainstorming](https://github.com/obra/superpowers/tree/main/skills/brainstorming) | ⭐268,114 | 把粗略想法通过结构化提问变成完整方案 |
| [kaizen](https://github.com/NeoLabHQ/context-engineering-kit/tree/master/plugins/kaizen/skills/kaizen) | ⭐1,305 | 持续改进方法论，多种分析框架 |
...
| [google-workspace-skills](https://github.com/sanjay3290/ai-skills/tree/main/skills) | ⭐366 | Google 全家桶集成：Gmail、日历、Chat 等 |
...
| Skill | 来源 | 说明 |
|-------|------|------|
| [root-cause-tracing](https://github.com/obra/superpowers/tree/main/skills/root-cause-tracing) | ⭐268,114 | 错误深藏在执行链路时，追溯根本原因 |
| [CSV Data Summarizer](https://github.com/coffeefuelbump/csv-data-summarizer-claude-skill) | ⭐443 | 自动分析 CSV 文件并生成完整数据报告 🕰<sub>2025-10-16 后未更新</sub> |
| [deep-research](https://github.com/sanjay3290/ai-skills/tree/main/skills/deep-research) | ⭐366 | 调用 Gemini Deep Research 做自主多步研究 |
| [postgres](https://github.com/sanjay3290/ai-skills/tree/main/skills/postgres) | ⭐366 | 对 PostgreSQL 执行安全的只读 SQL 查询 |
...
| Skill | 来源 | 说明 |
|-------|------|------|
| [reverse-skill](https://github.com/zhaoxuya520/reverse-skill) | ⭐19,867 | 逆向工程与授权渗透测试的 Skill 路由包 |
...
我们 11 个原创 Skill 都写明了边界——记账不做税务筹划、辅导作业不给答案、
...
*本文件由脚本从 `data/skills.json` 自动生成，最后更新 2026-08-07。*  
