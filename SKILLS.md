...
| Skill | 来源 | 说明 |
|-------|------|------|
| [humanizer-zh](https://github.com/op7418/humanizer-zh) | ⭐15,066 | 去除文本里的 AI 生成痕迹。基于维基百科「AI 写作特征」整理，检测并修复：夸大的象征意义、宣传性语言、-ing 结尾的肤浅分析、模糊归因、破折号过度使用、三段式法则、AI 词汇、否定式排比 🕰<sub>2026-01-19 后未更新</sub> |
| [zhangxuefeng-skill](https://github.com/alchaincyf/zhangxuefeng-skill) | ⭐10,116 | 张雪峰的思维框架与表达方式：基于 5 本著作、15+ 篇采访、30+ 条语录整理出 5 个心智模型与 8 条决策启发式。用于分析教育选择、职业规划、阶层流动 |
| [dbskill](https://github.com/dontbesilent2025/dbskill) | ⭐9,401 | 个人技能合集（30 个）：公众号 HTML 排版、用阿德勒心理学框架诊断执行阻滞（知道该做却拖延时用）等 |
| [superpowers-zh](https://github.com/jnMetaCode/superpowers-zh) | ⭐7,608 | superpowers 中文版：26万⭐框架完整汉化 + 6 个中国原创 skill |
| [gzh-design-skill](https://github.com/isjiamu/gzh-design-skill) | ⭐3,010 | 微信公众号排版引擎：Markdown → 可直接粘进公众号编辑器的 HTML。6 套主题 + 主题生成器，自动章节编号、引言卡片、目录导航，支持 Word/PDF 输入 |
| [codex-claude-academic-skills](https://github.com/zLanqing/codex-claude-academic-skills) | ⭐2,776 | 学术科研三件套：文献阅读、论文写作、科学计算全流程 |
| [everything-claude-code-zh](https://github.com/xu-xiang/everything-claude-code-zh) | ⭐1,845 | Claude Code 完整配置中文翻译（agents/skills/hooks/commands） |
...
| [xiaohu-wechat-format](https://github.com/xiaohuailabs/xiaohu-wechat-format) | ⭐682 | 公众号一键排版发布：Markdown → 微信 HTML，30 套主题 |
...
| [cuimao-translator](https://github.com/Cuimao777/cuimao-translator) | ⭐460 | 一键把英文 PDF 翻译成流畅中文 |
| [video-recap-skills](https://github.com/worldwonderer/video-recap-skills) | ⭐449 | 把任意视频剪成解说式短片 |
| [yupi-skill](https://github.com/liyupi/yupi-skill) | ⭐406 | 程序员鱼皮技能包：编程学习、求职面试、技术选型、创业经验 |
| [xiaohongshu-skills](https://github.com/vivy-yi/xiaohongshu-skills) | ⭐370 | 139 个小红书运营技能：内容创作、账号运营、电商转化等 9 大类 🕰<sub>2026-01-23 后未更新</sub> |
...
| [skills_collection](https://github.com/wwwzhouhui/skills_collection) | ⭐260 | 个人实用技能集，覆盖开发效率与内容创作 |
| [humanizer-zh-academic](https://github.com/redbaronyyyyy-eng/humanizer-zh-academic) | ⭐245 | 降低中文学术写作 AIGC 检测率 |
| [awesome-skills-cn](https://github.com/lingxling/awesome-skills-cn) | ⭐239 | 热门 Skills 中文学习版 + 教程，7000+ 收录 |
...
| [SecSkills](https://github.com/Arenbai/SecSkills) | ⭐205 | 渗透测试技能模块，遵循 PTES 标准全阶段覆盖 |
...
| [JobOK](https://github.com/GresonKwan/JobOK) | ⭐123 | 中文求职：优势挖掘、岗位匹配、简历优化、面试训练 |
...
| [stop-slop-zh](https://github.com/VincentOld/stop-slop-zh) | ⭐64 | 消除中文 AI 写作痕迹：拆排比、去名词化、换具体细节 |
...
| [open-notebook](https://github.com/lfnovo/open-notebook) | ⭐36,710 | NotebookLM 的开源替代，灵活度和功能更强。含发布流程编排技能（变更日志审计、风险分级测试矩阵、Docker 镜像门禁） |
| [NotebookLM Integration](https://github.com/PleasePrompto/notebooklm-skill) | ⭐7,599 | 让 Claude Code 直接对话 NotebookLM，做有出处的问答 🕰<sub>2025-11-21 后未更新</sub> |
...
| [test-driven-development](https://github.com/obra/superpowers/tree/main/skills/test-driven-development) | ⭐270,554 | 测试驱动开发全流程指导，写代码前先写测试 |
| [using-git-worktrees](https://github.com/obra/superpowers/blob/main/skills/using-git-worktrees/) | ⭐270,554 | 自动创建隔离的 git worktree，多分支并行开发不打架 |
| [finishing-a-development-branch](https://github.com/obra/superpowers/tree/main/skills/finishing-a-development-branch) | ⭐270,554 | 开发分支收尾：合并、清理、发布的标准流程 |
| [system_prompts_leaks](https://github.com/asgeirtj/system_prompts_leaks) | ⭐62,742 | 各家 AI 产品的系统提示词收集：Anthropic（Claude Fable 5 / Opus 5 / Claude Code）、OpenAI（GPT-5.6-Sol / Codex）等，持续更新。含 9 个 SKILL.md |
| [planning-with-files](https://github.com/othmanadi/planning-with-files) | ⭐26,095 | Manus 式的文件化持久规划：把 task_plan.md / findings.md / progress.md 落到磁盘，上下文丢了工作也不丢。含 18 个子技能 |
| [baoyu-skills](https://github.com/jimliu/baoyu-skills) | ⭐24,846 | 宝玉的技能合集（22 个）：公众号摘要、发布流程自动化（自动识别版本文件与 changelog，支持 Node/Python/Rust/Claude Plugin）等 |
| [Skill Seekers](https://github.com/yusufkaraaslan/Skill_Seekers) | ⭐14,741 | 把任意文档网站自动转成 Claude Skill —— 造 skill 的利器 |
| [fireworks-tech-graph](https://github.com/yizhiyanhua-ai/fireworks-tech-graph) | ⭐9,832 | 生成技术图表：软件架构、数据流、流程图、时序图、C4 模型、云部署、事件流 |
| [reddit-fetch](https://github.com/ykdojo/claude-code-tips/tree/main/skills/reddit-fetch) | ⭐9,594 | 当 WebFetch 被拦时，通过 Gemini CLI 抓取 Reddit 内容 |
| [drawio-skill](https://github.com/Agents365-ai/drawio-skill) | ⭐7,450 | 用自然语言生成 draw.io 图表：11 种预设（UML、SysML/MBSE、BPMN、网络拓扑、C4 架构等），36 个工具 |
| [lean-ctx](https://github.com/yvgude/lean-ctx) | ⭐3,564 | AI 编程代理的上下文运行时，管理会话与上下文 |
| [Playwright Browser Automation](https://github.com/lackeyjb/playwright-skill) | ⭐3,013 | 用 Playwright 做浏览器自动化测试与验证 |
...
| [taste-skill](https://github.com/Leonxlnx/taste-skill) | ⭐75,452 | 让 AI 别再生成套路化口水内容。13 个子技能：品牌套件、极简、粗野主义、图生代码、前端配图（Web/移动端）等，主打有审美的产出 |
...
| [imagen](https://github.com/sanjay3290/ai-skills/tree/main/skills/imagen) | ⭐397 | 调用 Google Gemini 图像生成 API 出图 |
...
| [brainstorming](https://github.com/obra/superpowers/tree/main/skills/brainstorming) | ⭐270,554 | 把粗略想法通过结构化提问变成完整方案 |
| [pm-skills](https://github.com/phuryn/pm-skills) | ⭐25,162 | 产品经理技能市场：68 个 PM Skill + 42 条链式工作流，打包成 9 个插件。覆盖需求发现、产品策略、执行、上线到增长。⚠️ 方法论偏国外语境，国内 PM 可作参考 |
| [kaizen](https://github.com/NeoLabHQ/context-engineering-kit/tree/master/plugins/kaizen/skills/kaizen) | ⭐1,308 | 持续改进方法论，多种分析框架 |
| [Brand Build Skills](https://github.com/rampstackco/claude-skills) | ⭐532 | 59 个 skill 的品牌与网站全生命周期库 |
...
| [google-workspace-skills](https://github.com/sanjay3290/ai-skills/tree/main/skills) | ⭐397 | Google 全家桶集成：Gmail、日历、Chat 等 |
...
| Skill | 来源 | 说明 |
|-------|------|------|
| [root-cause-tracing](https://github.com/obra/superpowers/tree/main/skills/root-cause-tracing) | ⭐270,554 | 错误深藏在执行链路时，追溯根本原因 |
...
| [deep-research](https://github.com/sanjay3290/ai-skills/tree/main/skills/deep-research) | ⭐397 | 调用 Gemini Deep Research 做自主多步研究 |
| [postgres](https://github.com/sanjay3290/ai-skills/tree/main/skills/postgres) | ⭐397 | 对 PostgreSQL 执行安全的只读 SQL 查询 |
...
| Skill | 来源 | 说明 |
|-------|------|------|
| [reverse-skill](https://github.com/zhaoxuya520/reverse-skill) | ⭐23,734 | 逆向工程与授权渗透测试的 Skill 路由包 |
