...
| Skill | 来源 | 说明 |
|-------|------|------|
| [humanizer-zh](https://github.com/op7418/humanizer-zh) | ⭐15,008 | 去除文本里的 AI 生成痕迹。基于维基百科「AI 写作特征」整理，检测并修复：夸大的象征意义、宣传性语言、-ing 结尾的肤浅分析、模糊归因、破折号过度使用、三段式法则、AI 词汇、否定式排比 🕰<sub>2026-01-19 后未更新</sub> |
| [zhangxuefeng-skill](https://github.com/alchaincyf/zhangxuefeng-skill) | ⭐10,111 | 张雪峰的思维框架与表达方式：基于 5 本著作、15+ 篇采访、30+ 条语录整理出 5 个心智模型与 8 条决策启发式。用于分析教育选择、职业规划、阶层流动 |
| [dbskill](https://github.com/dontbesilent2025/dbskill) | ⭐9,383 | 个人技能合集（30 个）：公众号 HTML 排版、用阿德勒心理学框架诊断执行阻滞（知道该做却拖延时用）等 |
| [superpowers-zh](https://github.com/jnMetaCode/superpowers-zh) | ⭐7,594 | superpowers 中文版：26万⭐框架完整汉化 + 6 个中国原创 skill |
| [gzh-design-skill](https://github.com/isjiamu/gzh-design-skill) | ⭐2,975 | 微信公众号排版引擎：Markdown → 可直接粘进公众号编辑器的 HTML。6 套主题 + 主题生成器，自动章节编号、引言卡片、目录导航，支持 Word/PDF 输入 |
| [codex-claude-academic-skills](https://github.com/zLanqing/codex-claude-academic-skills) | ⭐2,752 | 学术科研三件套：文献阅读、论文写作、科学计算全流程 |
| [everything-claude-code-zh](https://github.com/xu-xiang/everything-claude-code-zh) | ⭐1,844 | Claude Code 完整配置中文翻译（agents/skills/hooks/commands） |
| [agent-skills-with-anthropic](https://github.com/datawhalechina/agent-skills-with-anthropic) | ⭐1,453 | 吴恩达 DeepLearning.AI 课程的中文翻译与知识整理 |
| [shuorenhua](https://github.com/MrGeDiao/shuorenhua) | ⭐1,000 | 「说人话」去 AI 味改写：保事实、分场景、改完可直接发 |
| [Awesome-Journal-Skills](https://github.com/brycewang-stanford/Awesome-Journal-Skills) | ⭐972 | 主流期刊投稿技能包（AER、QJE 等经济学顶刊） |
| [speak-human-tw](https://github.com/Raymondhou0917/speak-human-tw) | ⭐776 | 繁体中文去 AI 味：抓 38 种 AI 写作痕迹，校正用语与标点 |
| [claude-code-skills-zh](https://github.com/laolaoshiren/claude-code-skills-zh) | ⭐750 | 面向中文开发者的技能库，按场景分类、复制即装 |
...
| [video-recap-skills](https://github.com/worldwonderer/video-recap-skills) | ⭐448 | 把任意视频剪成解说式短片 |
| [yupi-skill](https://github.com/liyupi/yupi-skill) | ⭐406 | 程序员鱼皮技能包：编程学习、求职面试、技术选型、创业经验 |
| [xiaohongshu-skills](https://github.com/vivy-yi/xiaohongshu-skills) | ⭐368 | 139 个小红书运营技能：内容创作、账号运营、电商转化等 9 大类 🕰<sub>2026-01-23 后未更新</sub> |
| [docx-skill-4-cn-paper](https://github.com/Gostyan/docx-skill-4-cn-paper) | ⭐358 | 中文论文排版规范：课程论文、数模竞赛、毕业论文 |
| [humanities-writing-companion](https://github.com/tizzy916/humanities-writing-companion) | ⭐355 | 人文学科写作助手：11 种模式覆盖构思到成稿 |
| [universal-examprep-skill](https://github.com/ZeKaiNie/universal-examprep-skill) | ⭐284 | 考前突击教练：把课件资料变成应试重点 |
...
| [humanizer-zh-academic](https://github.com/redbaronyyyyy-eng/humanizer-zh-academic) | ⭐246 | 降低中文学术写作 AIGC 检测率 |
| [awesome-skills-cn](https://github.com/lingxling/awesome-skills-cn) | ⭐238 | 热门 Skills 中文学习版 + 教程，7000+ 收录 |
...
| [SecSkills](https://github.com/Arenbai/SecSkills) | ⭐204 | 渗透测试技能模块，遵循 PTES 标准全阶段覆盖 |
...
| [JobOK](https://github.com/GresonKwan/JobOK) | ⭐122 | 中文求职：优势挖掘、岗位匹配、简历优化、面试训练 |
...
| [NotebookLM Integration](https://github.com/PleasePrompto/notebooklm-skill) | ⭐7,597 | 让 Claude Code 直接对话 NotebookLM，做有出处的问答 🕰<sub>2025-11-21 后未更新</sub> |
...
| [test-driven-development](https://github.com/obra/superpowers/tree/main/skills/test-driven-development) | ⭐270,233 | 测试驱动开发全流程指导，写代码前先写测试 |
| [using-git-worktrees](https://github.com/obra/superpowers/blob/main/skills/using-git-worktrees/) | ⭐270,233 | 自动创建隔离的 git worktree，多分支并行开发不打架 |
| [finishing-a-development-branch](https://github.com/obra/superpowers/tree/main/skills/finishing-a-development-branch) | ⭐270,233 | 开发分支收尾：合并、清理、发布的标准流程 |
| [planning-with-files](https://github.com/othmanadi/planning-with-files) | ⭐26,084 | Manus 式的文件化持久规划：把 task_plan.md / findings.md / progress.md 落到磁盘，上下文丢了工作也不丢。含 18 个子技能 |
| [baoyu-skills](https://github.com/jimliu/baoyu-skills) | ⭐24,819 | 宝玉的技能合集（22 个）：公众号摘要、发布流程自动化（自动识别版本文件与 changelog，支持 Node/Python/Rust/Claude Plugin）等 |
| [Skill Seekers](https://github.com/yusufkaraaslan/Skill_Seekers) | ⭐14,737 | 把任意文档网站自动转成 Claude Skill —— 造 skill 的利器 |
| [fireworks-tech-graph](https://github.com/yizhiyanhua-ai/fireworks-tech-graph) | ⭐9,811 | 生成技术图表：软件架构、数据流、流程图、时序图、C4 模型、云部署、事件流 |
| [reddit-fetch](https://github.com/ykdojo/claude-code-tips/tree/main/skills/reddit-fetch) | ⭐9,591 | 当 WebFetch 被拦时，通过 Gemini CLI 抓取 Reddit 内容 |
| [drawio-skill](https://github.com/Agents365-ai/drawio-skill) | ⭐7,410 | 用自然语言生成 draw.io 图表：11 种预设（UML、SysML/MBSE、BPMN、网络拓扑、C4 架构等），36 个工具 |
| [lean-ctx](https://github.com/yvgude/lean-ctx) | ⭐3,561 | AI 编程代理的上下文运行时，管理会话与上下文 |
| [Playwright Browser Automation](https://github.com/lackeyjb/playwright-skill) | ⭐3,014 | 用 Playwright 做浏览器自动化测试与验证 |
...
| [iOS Simulator](https://github.com/conorluddy/ios-simulator-skill) | ⭐1,209 | 操作 iOS 模拟器做 App 测试 |
...
| [imagen](https://github.com/sanjay3290/ai-skills/tree/main/skills/imagen) | ⭐396 | 调用 Google Gemini 图像生成 API 出图 |
| [swiftui-design-skill](https://github.com/wholiver/swiftui-design-skill) | ⭐164 | SwiftUI 前端设计（中文）：反 AI 味六条铁律、设计顾问、五维评审 |
| [anydesign](https://github.com/uxKero/anydesign) | ⭐154 | 分析任意图片/网址/Figma 文件，生成结构化设计规范 |
...
| [brainstorming](https://github.com/obra/superpowers/tree/main/skills/brainstorming) | ⭐270,233 | 把粗略想法通过结构化提问变成完整方案 |
| [kaizen](https://github.com/NeoLabHQ/context-engineering-kit/tree/master/plugins/kaizen/skills/kaizen) | ⭐1,308 | 持续改进方法论，多种分析框架 |
| [Brand Build Skills](https://github.com/rampstackco/claude-skills) | ⭐529 | 59 个 skill 的品牌与网站全生命周期库 |
...
| [google-workspace-skills](https://github.com/sanjay3290/ai-skills/tree/main/skills) | ⭐396 | Google 全家桶集成：Gmail、日历、Chat 等 |
| [n8n-skills](https://github.com/haunchen/n8n-skills) | ⭐386 | 让 AI 直接理解和操作 n8n 工作流 |
| [seo-geo-claude-skills](https://github.com/aaron-he-zhu/seo-geo-claude-skills) | ⭐146 | SEO / GEO（生成式引擎优化）技能集，20 个子技能：外链分析、关键词研究、内容写作等。139 星但 2.6 万安装 —— 星数完全反映不出使用量 |
...
| Skill | 来源 | 说明 |
|-------|------|------|
| [root-cause-tracing](https://github.com/obra/superpowers/tree/main/skills/root-cause-tracing) | ⭐270,233 | 错误深藏在执行链路时，追溯根本原因 |
...
| [deep-research](https://github.com/sanjay3290/ai-skills/tree/main/skills/deep-research) | ⭐396 | 调用 Gemini Deep Research 做自主多步研究 |
| [postgres](https://github.com/sanjay3290/ai-skills/tree/main/skills/postgres) | ⭐396 | 对 PostgreSQL 执行安全的只读 SQL 查询 |
...
| Skill | 来源 | 说明 |
|-------|------|------|
| [reverse-skill](https://github.com/zhaoxuya520/reverse-skill) | ⭐23,354 | 逆向工程与授权渗透测试的 Skill 路由包 |
