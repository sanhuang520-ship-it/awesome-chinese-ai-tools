...
| Codex 自动触发 | ⚠️ 3 / 13 | 3 个 Skill 单任务通过；不能外推到所有提示词与版本 |
...
按真实任务继续验证 Codex 自动触发，下一批优先测试高风险边界：`bookkeeping-cn`、`ecommerce-copywriting`、`homework-tutor-cn`。每条记录至少包含任务原文、客户端与版本、是否自动触发、关键输出、人工修改和已知限制。
